...
public class SItemStackV1 {
    ...
    public SItemStackV1(Material material){
        item = new ItemStack(material);
    }

    public SItemStackV1(String data){
        try {
            ByteArrayInputStream inputStream = new ByteArrayInputStream(Base64Coder.decodeLines(data));
            BukkitObjectInputStream dataInput = new BukkitObjectInputStream(inputStream);
            ItemStack item = (ItemStack) dataInput.readObject();
            dataInput.close();
            Bukkit.broadcastMessage(String.valueOf(item.getAmount()));
            convertItemStackToSItemStackV1(item);
        } catch (Exception e) {
        }
    }

    public SItemStackV1(ItemStack item){
        convertItemStackToSItemStackV1(item);
    }
    ...
    public SItemStackV1 setAmount(int amount){
        this.amount = amount;
        return this;
    }

    public SItemStackV1 setDisplayname(String name){
        this.displayName = name;
        return this;
    }

    public SItemStackV1 addLore(String lore){
        this.lore.add(lore);
        return this;
    }

    public SItemStackV1 setItemLore(List<String> lores){
        lore = lores;
        return this;
    }

    public SItemStackV1 addEnchantment(Enchantment enchant, int level){
        SEnchant s = new SEnchant(enchant,level);
        enchantments.add(s);
        return this;
    }

    public SItemStackV1 addFlag(ItemFlag itemFlag){
        this.flags.add(itemFlag);
        return this;
    }

    public SItemStackV1 setFlags(List<ItemFlag> itemFlags){
        this.flags = flags;
        return this;
    }

    public SItemStackV1 setDamage(int damage){
        this.damage = damage;
        ItemStack item = new ItemStack(Material.AIR,1,(short) 1);
        return this;
    }

    public SItemStackV1 setGlowingEffect(boolean enabled){
        isGlowing = enabled;
        return this;
    }

    public SItemStackV1 setUnBreakable(boolean enabled){
        isUnbreakable = enabled;
        return this;
    }

    public SItemStackV1 setSkullPlayer(String skullOwner){
        this.skullMode = true;
    ...
    public SItemStackV1 setSkullUrl(String url){
        this.skullMode = true;
        this.item = new ItemStack(Material.SKULL_ITEM,1,(short) 3);
        this.url = url;
        return this;
    ...
    public SItemStackV1 convertItemStackToSItemStackV1(ItemStack item) {
        resetSettings();
